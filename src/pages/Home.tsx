        ...
        <div className="flex items-center gap-2">
          {isCommitteeOrAdmin ? (
            ...
            <div className="flex items-center gap-1.5">
              <div className="flex items-center gap-1.5 text-[11px] font-bold text-[#9A3412] bg-[#EA580C]/8 px-3 py-1.5 rounded-full border border-[#EA580C]/20">
                <UserCircle2 className="w-3.5 h-3.5 text-[#EA580C]" />
                <span className="max-w-[80px] truncate">{user?.username}</span>
              </div>
              <button
                onClick={logout}
                className="flex items-center gap-1 text-[11px] font-bold text-[#756D65] bg-[#F3EEE6] hover:bg-[#E5DDD2] px-2.5 py-1.5 rounded-full border border-[#E5DDD2] active:scale-95 transition-all cursor-pointer"
                title="Logout"
              >
