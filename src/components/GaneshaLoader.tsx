...
export const GaneshaLoader: React.FC<GaneshaLoaderProps> = ({
  message = "TEAM GARUDA",
  subMessage = "nagarjuna street",
  isFullPage = true,
}) => {
  return (
    <div className={`flex flex-col items-center justify-center select-none z-50 bg-primary-bg ${isFullPage ? 'fixed inset-0 sm:absolute' : 'w-full h-full min-h-[300px]'
      } animate-fade-in`}>
